...
p = ['.param w1=' num2str(x(1)) ' w2=' num2str(x(2))...
    ...
    ' CL=' num2str(x(9)) ' CAPc=' num2str(x(10)) ' l1=' num2str(x(11))...
    ' l2=' num2str(x(12)) ' l3=' num2str(x(13)) ' l4=' num2str(x(14))...
    ' l5=' num2str(x(15)) ' l6=' num2str(x(16)) ' l7=' num2str(x(17))...
    ' l8=' num2str(x(18)) ' Iref=' num2str(x(19))];
