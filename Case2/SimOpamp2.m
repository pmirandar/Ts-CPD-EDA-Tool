function [Area,R,Objetivos] = SimOpamp2(obj,v)
% Execute the simulation of the Opamp,
...
x=[w1 w2 w3 w4 w5 w6 w7 w8 CL Cc...
   l1 l2 l3 l4 l5 l6 l7 l8 Iref];
...
Objetivos=[a(1) b(frecuency) pm_deg x(9) (getSR(tiempo,voltaje)/1e6)...
...
% Calcula la potencia del circuito
...
%
Area = x(1)*x(11) + x(2)*x(12) + x(3)*x(13)...
     + x(4)*x(14) + x(5)*x(15) + x(6)*x(16)...
     + x(7)*x(17) + x(8)*x(18);
end
